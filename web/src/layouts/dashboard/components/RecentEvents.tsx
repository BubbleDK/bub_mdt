...
const RecentEvents: React.FC = () => {
    ...
    const [event, setEvents] = useState([{id: 1, eventCat: 'incident', event: 'created', editBy: 'John Doe', editedAt: 'a few seconds ago'}, {id: 2, eventCat: 'profile', event: 'edited', editBy: 'John Doe', editedAt: 'a few seconds ago'}, {id: 3, eventCat: 'incident', event: 'created', editBy: 'John Doe', editedAt: '10 minutes ago'}, {id: 4, eventCat: 'profile', event: 'created', editBy: 'John Doe', editedAt: 'a few seconds ago'}]);
