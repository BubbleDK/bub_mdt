...
const WarrantTable: React.FC = () => {
  ...
  const [warrants, setWarrants] = useState([{
    ...
    id: 1
  }, {image: '', name: 'John Doe', reason: 'Reckless Driving', expiresIn: 'expires in 5 days', id: 2}, {
    image: '',
    name: 'John Doe',
    reason: 'Reckless Driving',
    expiresIn: 'expires in 5 days',
    id: 3
  }, {image: '', name: 'John Dope', reason: 'Reckless Driving', expiresIn: 'expires in 10 days', id: 4}, {
    image: '',
    name: 'John Doe',
    reason: 'Reckless Driving',
    expiresIn: 'expires in 5 days',
    id: 5
  }, {image: '', name: 'John Doe', reason: 'Reckless Driving', expiresIn: 'expires in 5 days', id: 6}, {
    image: '',
    name: 'John Doe',
    reason: 'Reckless Driving',
    expiresIn: 'expires in 5 days',
    id: 7
  }, {image: '', name: 'John Doe', reason: 'Reckless Driving', expiresIn: 'expires in 5 days', id: 8}, {
    image: '',
    name: 'John Doe',
    reason: 'Reckless Driving',
    expiresIn: 'expires in 5 days',
      ...
      <td className={classes.onHover}>
        <Menu withArrow>
          ...
          <Menu.Dropdown>
            ...
            <Menu.Item color="red" onClick={() => deleteWarrant(item.id)} icon={<IconTrash size={14}/>}>Delete
              warrant</Menu.Item>
          </Menu.Dropdown>
        </Menu>
      </td>
